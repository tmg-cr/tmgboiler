    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">tmgboiler</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
            
           <Link to="/cust_locations">
            <ListItem button key="Cust_Location">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Cust_Location" />
            </ListItem>
          </Link>{" "}            
           <Link to="/customers">
           ...
           <Link to="/devices">
            <ListItem button key="Device">
              ...
              <ListItemText className="menu-text" primary="Device" />
            </ListItem>
          </Link>{" "}            
           <Link to="/users">
