...
// Database
import Database_Tmgboiler_db from "./Database_Tmgboiler_db.js";

// Controllers
import Cust_LocationController from "../controllers/Tmgboiler_db/Cust_LocationController";
import CustomerController from "../controllers/Tmgboiler_db/CustomerController";
import DeviceController from "../controllers/Tmgboiler_db/DeviceController";
import UserController from "../controllers/Tmgboiler_db/UserController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		Cust_LocationController.init(router);
		CustomerController.init(router);
		DeviceController.init(router);
